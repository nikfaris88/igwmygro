...
public abstract class SingleInputFormActivity extends AppCompatActivity {
    ...
    private int stepIndex = 0; // stepIndex = 1;
...
//        container = (FrameLayout) findViewById(R.id.container);
    ...
    private void updateStep() {
        Log.d("SingleInputForm", "stepIndex: " + stepIndex + " steps.size(): " + steps.size());
        if (stepIndex >= steps.size()) {
            lastStep();
            hideSoftInput();
...
//            }
    ...
    private void updateViews() {
        ...
        if (stepIndex + 1 >= steps.size()) { // stepIndex + 1 >= steps.size()
    ...
    protected void previousStep() {
        Log.d("SingleInputForm", "stepIndex before: " + stepIndex);
        setupData = getCurrentStep().save(setupData);
        Log.d("SingleInputForm", "isLastStep: " + isLastStep);
        if (isLastStep) {
            stepIndex = 0;
        } else {
            stepIndex--;
        }
        Log.d("SingleInputForm", "stepIndex after: " + stepIndex);
        updateStep();
    }
